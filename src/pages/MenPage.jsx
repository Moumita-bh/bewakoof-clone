...
const mockProducts = [
  {
    ...
    offer: 'Buy 2 For 999',
    discount: 10,
    image: 'https://images.bewakoof.com/t640/men-s-black-iron-man-of-war-graphic-printed-t-shirt-220650-1730990210-1.jpg',
    rating: 4.6,
  },
  {
    _id: '2',
     ...
     <div>
      ...
      <div className="px-4 py-4 pl-20">
        <p className="text-sm">
          ...
          <span className="text-black">Men Clothing</span>
        </p>
      </div>

      {/* Filter, Title, and Sort By Row */}
      <div className="px-4 py-2 flex justify-between items-start pl-15">
        {/* Left - Filter */}
